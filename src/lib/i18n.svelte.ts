...
const EN: Dict = {
  ...
  "split.pickFileHint": "Don't see your app (e.g. a Steam game)? Pick its .exe file.",
  "split.manualHint": "Don't see your app (e.g. a Steam game)? Choose its .exe file.",
  "split.manualPlaceholder": "Executable path",
  ...
  "settings.killswitchUnavailableWindows": "Unavailable in this Windows preview while the enforcement backend is being replaced.",
  ...
  "settings.logLevelSub": "Verbosity of the Xray VPN log.",
...
const RU: Dict = {
  ...
  "split.pickFileHint": "Нет вашего приложения (например, игры Steam)? Выберите его .exe-файл.",
  "split.manualHint": "Нет приложения в списке (например, игры Steam)? Выберите его .exe-файл.",
  "split.manualPlaceholder": "Путь к исполняемому файлу",
  ...
  "settings.killswitchUnavailableWindows": "Недоступен в этой Windows Preview, пока мы заменяем механизм фильтрации.",
  ...
  "settings.logLevelSub": "Подробность VPN-лога Xray.",
